...
- `luci-ssl`, peripherals, **luci-app-oled** (oledd menu), **cm5-button-scripts**, AmneziaWG in profile (no Docker, travelmate, blocky, luci-app-buttons, speedtest, SMB, DLNA, statistics, SQM, PBR, watchcat, fwknopd, privoxy)
