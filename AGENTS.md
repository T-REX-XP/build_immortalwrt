...
Cross-repo: **mcu-display-cm5** and **cm5-mcu-serial** in `openwrt-packages/.cursor/skills/` (Go mcudd, LuCI sidecar, picocom/socat on `ttyS2`). **esp32-cm5-router-fw** in `esp32-smartdisplay-demo`. Peripherals I2C/fan: **oled-peripherals-cm5**. IDS LuCI: **`suricata-ids-cm5`**, **`snort3-ids-cm5`**, **`cm5-security-stack`**.
